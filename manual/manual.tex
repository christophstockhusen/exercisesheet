...
\usepackage{titlesec}
\titleformat{\chapter}[display]{\raggedright\sffamily\huge}{Chapter~\thechapter}{1ex}{}
\titleformat{\section}[display]{\raggedright\sffamily\large}{Section~\thesection}{1ex}{}
\titleformat{\subsection}[display]{\raggedright\sffamily}{Subsection~\thesubsection}{1ex}{}
...
\def\documentoption#1#2{%
  ...
  \noindent
  \lstinline{#1}%
  \ifempty{#2}{}{\qquad default:~\lstinline{#2}}%
